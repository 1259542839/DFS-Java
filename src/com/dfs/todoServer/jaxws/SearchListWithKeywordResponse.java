...
@XmlRootElement(name = "searchListWithKeywordResponse", namespace = "http://todoServer.dfs.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "searchListWithKeywordResponse", namespace = "http://todoServer.dfs.com/")
public class SearchListWithKeywordResponse {
